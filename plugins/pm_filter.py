...
async def advantage_spell_chok(client, msg):
    ...
    btn.append([[ InlineKeyboardButton("🔍 sᴇᴀʀᴄʜ ᴛᴏ ɢᴏᴏɢʟᴇ 🔎", url=f"https://www.google.com") ],[InlineKeyboardButton(text="Close", callback_data=f'spolling#{user}#close_spellcheck')]])
